...
<html lang="en" data-bs-theme="auto">
  ...
  <body>
            ...
            <table class="table table-striped table-sm">
              ...
              <?php foreach ($news_list as $news_item): ?>
                <tr>
                  ...
                  <th scope="col">Actualizar Noticia</th>
                  <th scope="col">Borrar Noticia</th>
                </tr>
              </thead>
              <tbody>
                <tr>
    ...
    <script
      ...
      src="<?= base_url('assets/dist/js/bootstrap.bundle.min.js')?>" class="astro-vvvwv3sm"
    ></script>
    <script
    ...
    <script src="<?= base_url('assets/js/color-modes.js')?>" class="astro-vvvwv3sm"></script>
  </body>
</html>
